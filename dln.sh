...
read NUMBER
case $NUMBER in
  0)bash <(curl -Ls https://raw.githubusercontent.com/sburns1369/Delion_MN_Script/master/DeLion_singleV4.sh);;
  1)bash <(curl -Ls https://raw.githubusercontent.com/sburns1369/Delion_MN_Script/master/DeLion_singleV6.sh);;
