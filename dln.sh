...
COINHOME=/home/delion
#wallet downnload and extractions commands
DOWNLOADCOINFILES=https://github.com/delioncoin/delioncore/releases/download/v1.0/Linux.zip
COINFILES=Linux.zip
DECOMPRESS=unzip
#rocketstrap
...
ADDNODE4=178.128.50.151:15858
ADDNODE5=185.28.100.82:15858
COINPORT=15858
COINRPCPORT=15960
...
echo -e "         ."
  ...
  echo "addnode=188.40.182.64:15858" >> /home/${COINl}${nodeunit}/.${COINl}/${COINCONFIG}
  echo "addnode=37.187.186.253:15858" >> /home/${COINl}${nodeunit}/.${COINl}/${COINCONFIG}
  echo "addnode=95.217.54.144:15858" >> /home/${COINl}${nodeunit}/.${COINl}/${COINCONFIG}
  echo "addnode=137.74.107.113:15858" >> /home/${COINl}${nodeunit}/.${COINl}/${COINCONFIG}
  fi
  }
