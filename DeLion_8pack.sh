...
echo "rpcport=15963" >> /home/delion5/delion.conf
echo "listen=0" >> /home/delion5/delion.conf
echo "externalip=[${MNIP5}]:15858" >> /home/delion5/delion.conf
echo "masternodeprivkey=$privkey5" >> /home/delion5/delion.conf
if [[ $NULLREC = "y" ]] ; then
echo "masterNode5 : true" >> /usr/local/nullentrydev/dln.log
echo "walletVersion5 : 1.0.0" >> /usr/local/nullentrydev/dln.log
echo "scriptVersion5 : 0.9d" >> /usr/local/nullentrydev/dln.log
fi
sleep 5
echo
echo -e "${GREEN}Configuring sixth DeLion Node${CLEAR}"
...
echo "rpcport=15964" >> /home/delion6/delion.conf
echo "listen=0" >> /home/delion6/delion.conf
echo "externalip=[${MNIP6}]:15858" >> /home/delion6/delion.conf
echo "masternodeprivkey=$privkey6" >> /home/delion6/delion.conf
if [[ $NULLREC = "y" ]] ; then
echo "masterNode6 : true" >> /usr/local/nullentrydev/dln.log
echo "walletVersion6 : 1.0.0" >> /usr/local/nullentrydev/dln.log
echo "scriptVersion6 : 0.9d" >> /usr/local/nullentrydev/dln.log
fi
sleep 5
echo
echo -e "${GREEN}Configuring seventh DeLion Node${CLEAR}"
...
echo "rpcport=15965" >> /home/delion7/delion.conf
echo "listen=0" >> /home/delion7/delion.conf
echo "externalip=[${MNIP7}]:15858" >> /home/delion7/delion.conf
echo "masternodeprivkey=$privkey7" >> /home/delion7/delion.conf
if [[ $NULLREC = "y" ]] ; then
echo "masterNode7 : true" >> /usr/local/nullentrydev/dln.log
echo "walletVersion7 : 1.0.0" >> /usr/local/nullentrydev/dln.log
echo "scriptVersion7 : 0.9d" >> /usr/local/nullentrydev/dln.log
fi
sleep 5
echo
echo -e "${GREEN}Configuring eigth DeLion Node${CLEAR}"
...
sleep 3
sudo cp -r /home/delion/.delion/* /home/delion5/.delion
sleep 3
sudo cp -r /home/delion/.delion/* /home/delion6/.delion
sleep 3
sudo cp -r /home/delion/.delion/* /home/delion7/.delion
sleep 3
sudo cp -r /home/delion/.delion/* /home/delion8/.delion
sleep 3
