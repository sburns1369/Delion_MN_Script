...
if id "delion7" >/dev/null 2>&1; then
echo -e ${YELLOW} "Found user delion7!"${CLEAR}
MN7=1
else
sudo adduser --system --home /home/delion7 delion7
MN7=0
fi
if id "delion8" >/dev/null 2>&1; then
echo -e ${YELLOW} "Found user delion8!"${CLEAR}
MN8=1
else
sudo adduser --system --home /home/delion8 delion8
MN8=0
fi
echo
echo
...
echo
if [ ! -f /home/delion7/.delion/delion.conf ]; then
if [ ! -f /home/delion7/delion.conf ]; then
echo -e "${GREEN}Seventh Delion Node Configuration Not Found....${CLEAR}"
echo -e "${YELLOW}Configuring Seventh Delion Node${CLEAR}"
sudo mkdir /home/delion7/.delion
sudo touch /home/delion7/delion.conf
echo "rpcuser=user"`shuf -i 100000-9999999 -n 1` >> /home/delion7/delion.conf
echo "rpcpassword=pass"`shuf -i 100000-9999999 -n 1` >> /home/delion7/delion.conf
echo "rpcallowip=127.0.0.1" >> /home/delion7/delion.conf
echo "server=1" >> /home/delion7/delion.conf
echo "daemon=1" >> /home/delion7/delion.conf
echo "maxconnections=250" >> /home/delion7/delion.conf
echo "masternode=1" >> /home/delion7/delion.conf
echo "rpcport=15967" >> /home/delion7/delion.conf
echo "listen=0" >> /home/delion7/delion.conf
echo "externalip=[${MNIP7}]:15858" >> /home/delion7/delion.conf
echo "masternodeprivkey=$MNKEY7" >> /home/delion7/delion.conf
if [[ $NULLREC = "y" ]] ; then
echo "masterNode7 : true" >> /usr/local/nullentrydev/dln.log
echo "walletVersion7 : 1.0.0" >> /usr/local/nullentrydev/dln.log
echo "scriptVersion7 : 0.99" >> /usr/local/nullentrydev/dln.log
fi
else
echo
echo -e ${YELLOW}"Found /home/delion7/delion.conf"${CLEAR}
echo -e ${YELLOW}"Skipping Pre-stage for Seventh Node "${CLEAR}
MN7=0
fi
else
echo -e ${YELLOW}"Found /home/delion7/.delion/delion.conf"${CLEAR}
echo -e ${YELLOW}"Skipping Configuration for Seventh Node"${CLEAR}
fi
echo
if [ ! -f /home/delion8/.delion/delion.conf ]; then
if [ ! -f /home/delion8/delion.conf ]; then
echo -e "${GREEN}Eigth Delion Node Configuration Not Found....${CLEAR}"
echo -e "${YELLOW}Configuring Eigth Delion Node${CLEAR}"
sudo mkdir /home/delion8/.delion
sudo touch /home/delion8/delion.conf
echo "rpcuser=user"`shuf -i 100000-9999999 -n 1` >> /home/delion8/delion.conf
echo "rpcpassword=pass"`shuf -i 100000-9999999 -n 1` >> /home/delion8/delion.conf
echo "rpcallowip=127.0.0.1" >> /home/delion8/delion.conf
echo "server=1" >> /home/delion8/delion.conf
echo "daemon=1" >> /home/delion8/delion.conf
echo "maxconnections=250" >> /home/delion8/delion.conf
echo "masternode=1" >> /home/delion8/delion.conf
echo "rpcport=15968" >> /home/delion8/delion.conf
echo "listen=0" >> /home/delion8/delion.conf
echo "externalip=[${MNIP8}]:15858" >> /home/delion8/delion.conf
echo "masternodeprivkey=$MNKEY8" >> /home/delion8/delion.conf
if [[ $NULLREC = "y" ]] ; then
echo "masterNode8 : true" >> /usr/local/nullentrydev/dln.log
echo "walletVersion8 : 1.0.0" >> /usr/local/nullentrydev/dln.log
echo "scriptVersion8 : 0.99" >> /usr/local/nullentrydev/dln.log
fi
else
echo
echo -e ${YELLOW}"Found /home/delion8/delion.conf"${CLEAR}
echo -e ${YELLOW}"Skipping Pre-stage for Eigth Node "${CLEAR}
MN8=0
fi
else
echo -e ${YELLOW}"Found /home/delion8/.delion/delion.conf"${CLEAR}
...
if [[ "$MN7" -eq "0" ]]; then
sudo cp -r /home/delion1/.delion/* /home/delion7/.delion
rm /home/delion7/.delion/delion.conf
cp -r /home/delion7/delion.conf /home/delion7/.delion/delion.conf
sleep 1
fi
if [[ "$MN8" -eq "0" ]]; then
sudo cp -r /home/delion1/.delion/* /home/delion8/.delion
rm /home/delion8/.delion/delion.conf
cp -r /home/delion8/delion.conf /home/delion8/.delion/delion.conf
sleep 1
fi
echo -e ${YELLOW}"Launching First DLN Node"${CLEAR}
deliond -datadir=/home/delion1/.delion -daemon
...
deliond -datadir=/home/delion5/.delion -daemon
sleep 20
echo -e ${YELLOW}"Launching Sixth DLN Node"${CLEAR}
deliond -datadir=/home/delion6/.delion -daemon
sleep 20
echo -e ${YELLOW}"Launching Seventh DLN Node"${CLEAR}
deliond -datadir=/home/delion7/.delion -daemon
sleep 20
echo -e ${YELLOW}"Launching Eigth DLN Node"${CLEAR}
deliond -datadir=/home/delion8/.delion -daemon
sleep 20
...
echo -e "${YELLOW}For mn7: \"delion-cli -datadir=/home/delion7/.delion masternode status\""${CLEAR}
echo -e "${YELLOW}For mn8: \"delion-cli -datadir=/home/delion8/.delion masternode status\""${CLEAR}
echo
...
echo -e "${BOLD} Masternode - \#7 IP: [${MNIP7}]:15858${CLEAR}"
echo -e "${BOLD} Masternode - \#8 IP: [${MNIP8}]:15858${CLEAR}"
fi
